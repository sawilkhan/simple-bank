...
// Source: github.com/sawilkhan/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTxn(arg0 context.Context, arg1 db.TransferTxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
